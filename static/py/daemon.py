    ...
    async def copy_file(self, src: str, dst: str, rel_path: str):
        async with self.copy_semaphore:
            ...
            try:
                    ...
                    while True:
                        ...
                        if progress > prev_progress + 0.01 or current_time - last_update_time > 0.5: # Update every 1% or 0.5s
                            ...
                            progress_msg = {
                                ...
                                "color": "green",          # Tailwind CSS color hint
                                "title": "Analysis complete",
                                "message": "Finished scanning Documents/Work/",
                                "timestamp": "2025-07-16T10:30:00Z" # ISO 8601 timestamp is best
                            }
                ...
                send_to_ui(json.dumps(activity_msg))
            except Exception as e:
